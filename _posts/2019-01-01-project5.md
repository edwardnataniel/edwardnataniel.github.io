...
### Master script
* A master script that will run all the steps above were written to automate the whole process. This code runs in the **high performance computing (hpc)** server of the Philippine Genome Center. 
